...
document.getElementById("resposta").innerHTML =  "Agendado com o colaborador " + nome + " para atendimento presencial em " + local + " no dia " + dataFinalFormatada  + " as " + hora + "hs." + "<br>Chamado Cervello:"  +  cervelo + " <br>Chamado Tim:" + chamadoTim;
